    ...
    <>
      ...
      <form className="my-4 w-full">
        <textarea
          ...
          placeholder-zinc-400 text-zinc-100 border-zinc-600 bg-transparent rounded-md focus:border-brand-500 
        ...
        focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-offset-brand-500 transition-colors"
          >
            Enviar Feedback
          </button>
        </footer>
